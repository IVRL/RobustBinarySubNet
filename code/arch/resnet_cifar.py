...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        #TODO: check correctness and apply to bottleneck block
...
class ResNet(nn.Module):
    def __init__(self, builder, block, num_blocks, num_classes=10):
        ...
        self.fc = builder.conv1x1(512 * block.expansion, num_classes, last_layer=True)
...
def cResNet18_cifar100():
    return ResNet(get_builder(), BasicBlock, [2, 2, 2, 2], num_classes=100)

def cResNet34_cifar100():
    return ResNet(get_builder(), BasicBlock, [3, 4, 6, 3], num_classes=100)

def cResNet50_cifar100():
