...
def imagenet100(batch_size, valid_ratio = None, shuffle = True, augmentation = True, train_subset = None):
    ...
    trainset = IndexedImageNet100(root = './data/imagenet100', split='train', transform = transform_train)
    validset = IndexedImageNet100(root = './data/imagenet100', split='train', transform = transform_valid)
    testset = IndexedImageNet100(root = './data/imagenet100', split='val', transform = transform_test)
